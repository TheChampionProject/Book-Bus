    ...
    <>
      <div className="fixed-top navbar NavHead" style={{ textAlign: "center" }}>
        <h2 style={{}} className="CPStyleFull">
          Thank you for volunteering for the Champion Project {username}!
        </h2>
      ...
      {!churchVerified ? (
        ...
        >
          <a href="https://ministryopportunities.org/opportunity/76424">
            In order to work with youth in the care of the state you will need
            to be background checked. This is a secure site and your personal
            information goes directly to the company doing our background
            checks. TCP will let you know within 2 business days if your
      ...
      {!didRequirements ? (
        ...
        >
          ...
          >
            You haven't completed the verification requirements! Click here to
            to do so.
          </a>
        </div>
      ) : (
      ...
      <div className="StatsArea" style={{ position: "relative", top: "3em" }}>
        ...
        <div className="Statistic">
          ...
          <p className="StatDescription">Give away books at an event</p>
        </div>
        <div className="Statistic">
          <button
            type="button"
        ...
        <div className="Statistic">
          <button
            ...
            className="btn btn-primary btn-square-md"
            onClick={() =>
              (window.location.href = "https://thechampionproject.org/donate/")
            }
          >
            Donate
          </button>
          <p className="StatDescription">
            Donate to the Champion Project. To verify each volunteer, it costs
            us $8. We appreciate any donations!
          </p>
        </div>
      </div>
